...
bestMove board depth = snd $ maximumBy bestScore possibilites where
    forest = subForest $ eval 2 1 (monteCarloTree depth 2 (board,0))
    possibilites = minimax (-10000) 10000 forest